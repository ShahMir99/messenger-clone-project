      ...
      <Dialog as="div" className="relative" onClose={Close}>
        ...
        <div className="fixed inset-0 overflow-hidden">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            >
              <DialogPanel className="relative overflow-hidden transform rounded-lg bg-white px-4 pb-4 text-left shadow-xl transition-all w-full sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
